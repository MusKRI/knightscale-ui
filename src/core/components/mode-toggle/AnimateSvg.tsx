...
import { useMotionValue, motion, Variants, useTransform } from "framer-motion";
...
const AnimateSvg = () => {
  ...
  const pathLengthMoon = useTransform(scaleMoon, [0, 1], [0, 1]);
  const moonStrokeDasharray = useTransform(scaleMoon, [0, 1], ["0 1", "1 1"]);

  const pathLengthSun = useTransform(scaleSun, [0, 1], [0, 1]);
  const sunStrokeDasharray = useTransform(scaleSun, [0, 1], ["0 1", "1 1"]);
          ...
          >
            <motion.path
              ...
              style={{
                ...
                strokeDasharray: sunStrokeDasharray,
                scale: scaleSun,
              }}
            />
            <motion.path
            ...
            <motion.path
              ...
              style={{
                ...
                strokeDasharray: moonStrokeDasharray,
                scale: scaleMoon,
              }}
            />
          </motion.svg>
